...
_SOURCEINFO.fields_by_name['source'].enum_type = get__updates__caller__info__pb2._GETUPDATESCALLERINFO_GETUPDATESSOURCE
...
_SYNCCYCLECOMPLETEDEVENTINFO.fields_by_name['num_blocking_conflicts']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_SYNCCYCLECOMPLETEDEVENTINFO.fields_by_name['num_non_blocking_conflicts'].has_options = True
_SYNCCYCLECOMPLETEDEVENTINFO.fields_by_name['num_non_blocking_conflicts']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
